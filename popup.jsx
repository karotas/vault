...
function Popup({
  ...
  return (
    ...
    >
      ...
      >
        <Typography color={darktheme ? "light.main" : "dark.main"}>
        ...
        <Stack
          ...
          spacing={1}
        >
          <Button color={darktheme ? "light" : "primary"} onClick={deleteItem}>
            yes
          </Button>
          <Button color={darktheme ? "light" : "primary"} onClick={cancel}>
            cancel
          </Button>
        </Stack>
      </Paper>
